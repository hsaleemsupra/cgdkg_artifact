...
const DOMAIN_PROOF_OF_DLEQ_CHALLENGE: &str = "crypto-nidkg-zk-proof-of-dleq-challenge";
...
impl DLEqInstance {
    ...
    pub fn check_instance(&self) -> Result<(), ZkProofDLEqError> {
        if self.g.equals(&ECP::new()) || self.h.equals(&ECP::new()) || self.g_x.equals(&ECP::new()) || self.h_x.equals(&ECP::new()) {
...
pub fn prove_gen(
    ...
    let c = dleq_proof_challenge(&instance.g, &instance.g_x, &instance.h, &instance.h_x, &g_k, &h_k);
...
pub fn verify_proof(
    ...
    let c_prime: BIG = dleq_proof_challenge(&instance.g, &instance.g_x, &instance.h, &instance.h_x, &g_k_prime, &h_k_prime);
...
mod test {
    ...
    use crate::nizk_dleq::{DLEqInstance, DLEqWitness, prove_gen, verify_proof, ZkProofDLEqError};
    ...
    fn dleq_nizk_should_verify() {
        ...
        let witness = DLEqWitness{ scalar_x: x, scalar_r: r };
    ...
    fn dleq_nizk_should_panic_on_different_exponent() {
        ...
        let witness = DLEqWitness{ scalar_x: x1, scalar_r: r };
        let nizk = prove_gen(&instance, &witness);
